...
// MergePlot merges (additively) the pixel with alpha on top of the existing image.
...
// DrawAALine draws an anti-aliased line using Xiaolin Wu's algorithm.
...
// DrawLine is a non-aliased version of the line drawing function.
